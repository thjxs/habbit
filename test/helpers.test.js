...
describe('# helpers isValidXss', function() {
  it('should detect script tags', () => {
    ...
    assert.strictEqual(
      helpers.isValidXss("<SCRIPT>alert('getting your password')</SCRIPT>"),
      true
    );
    assert.strictEqual(
      helpers.isValidXss(
        "<script src='http://xssinjections.com/inject.js'>xss</script>"
      ),
      true
    );
    assert.strictEqual(
      helpers.isValidXss(
        "<img src='/' onerror='javascript:alert('xss')'>xss</script>"
      ),
      true
    );
    assert.strictEqual(
      helpers.isValidXss("<script>console.log('XSS')</script>"),
      true
    );
  ...
  it('should not detect non script tags', function() {
    ...
    assert.strictEqual(
      helpers.isValidXss("<a notonlistener='nomatch'>"),
      false
    );
